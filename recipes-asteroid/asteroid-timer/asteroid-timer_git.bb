...
SRC_URI = "git://github.com/PureTryOut/asteroid-timer.git;branch=cmake;protocol=https"
SRCREV = "${AUTOREV}"
PR = "r1"
PV = "+git${SRCPV}"
S = "${WORKDIR}/git"
...
DEPENDS += "qml-asteroid nemo-qml-plugin-dbus nemo-keepalive qttools-native qtdeclarative-native"
