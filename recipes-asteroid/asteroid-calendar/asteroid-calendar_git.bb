...
SRC_URI = "git://github.com/PureTryOut/asteroid-calendar.git;branch=cmake;protocol=https"
SRCREV = "${AUTOREV}"
PR = "r1"
PV = "+git${SRCPV}"
S = "${WORKDIR}/git"
...
DEPENDS += "qml-asteroid qml-asteroid-native nemo-qml-plugin-calendar qttools-native qtdeclarative-native"
